            ...
            <div class="col-lg-2 col-md-2">
                <div class="list-group">
                    ...
                    foreach ($panels as $id => $panel) {
                        ...
                        echo Html::a($label, Url::to(['view', 'tag' => $tag, 'panel' => $id]), [
                ...
                <div class="callout <?= $calloutClass ?>">
                    <?php
                        ...
                        echo ButtonGroup::widget([
                            ...
                            'buttons' => [
                                Html::a('All', Url::to(['index']), ['class' => 'btn btn-default']),
                                Html::a('Latest', Url::to(['view', 'panel' => $activePanel->id]), ['class' => 'btn btn-default']),
