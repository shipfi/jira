...
<script type="text/javascript">
    mysoft.prepare(function(){
        function previewFile(fileUrl, fileType, returnUrl, fileSize) {
            ...
            if (fType == "doc" || fType == "docx" || fType == "xls" || fType == "xlsx" || fType == "ppt" || fType == "pptx" || fType == "pdf" || fType == "rar" || fType == "zip") {
                //url = tplData.SITES.preview_site + "view.aspx?src=" + $fileUrl;
                //encodeURIComponent(url);
                url = tplData.SITES.api_site + "/api/file/iframeview?url=" + $fileUrl+"&ftype="+fType+"&orgcode="+tplData.urlParams.__orgcode;
            }
...
//             }
            ...
            if (fType == "txt") {
                url = tplData.SITES.api_site + "/api/file/txt?url=" + $fileUrl + "&orgcode="+tplData.urlParams.__orgcode;
            }
