...
use mysoft\pubservice\CacheVisitLogService;
...
//         $key_rules= __()->pluck($key_rules,'cache_key');
        ...
        CacheVisitLogService::put(CacheVisitLogService::DO_KEY_RULE, self::KEY_RULE_KEY, $key_rules);
...
//            }
    ...
    public function get($key) {
        ...
        CacheVisitLogService::put(CacheVisitLogService::DO_GET, $key, $ret);
        return $ret;
    }
    
    public function add($key, $value, $duration = 0, $dependency = null) {
        CacheVisitLogService::put(CacheVisitLogService::DO_ADD, $key, $value);
